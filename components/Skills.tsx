    ...
    <section id="skills" className="py-20 lg:py-32 bg-arup-light-gray">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
          Throughout my university projects, I have developed and demonstrated a range of competencies aligned with the Creative Digital Design professional apprenticeship standard. These are categorized into Knowledge (K), Skills (S), and Behaviours (B).
        </p>
        <div className="mt-8">
            <a 
        ...
        <div className="mt-12 p-6 bg-white rounded-lg shadow-md max-w-4xl mx-auto text-left">
            ...
            <p className="text-gray-700">
                Each project in my portfolio is tagged with specific KSB codes. These codes correspond directly to the criteria outlined in the official standard. For example, a tag like <span className="font-mono bg-blue-100 text-blue-800 rounded px-1.5 py-0.5 text-sm">K1</span> refers to the first Knowledge requirement, while <span className="font-mono bg-green-100 text-green-800 rounded px-1.5 py-0.5 text-sm">S5</span> refers to the fifth Skill. This system provides a clear and transparent way to see how my work meets the academic and professional requirements of my course.
            </p>
        </div>
      </div>
    </section>
