  ...
  return (
    <section id="contact" className="py-20 lg:py-28">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <motion.div
          className="relative overflow-hidden rounded-3xl border border-arup-red/15 bg-[linear-gradient(135deg,#36363a_0%,#26262a_62%,#1b1b1e_100%)] p-8 text-white shadow-2xl shadow-black/20 dark:border-arup-red/25 dark:bg-[linear-gradient(135deg,#18181b_0%,#0f172a_58%,#020617_100%)] dark:shadow-black/35 sm:p-12 lg:p-14"
          {...reveal(0)}
        >
          ...
          <div className="relative z-10 text-center">
            <motion.div {...reveal(0.06)}>
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-gray-200 dark:text-slate-200">
            ...
            <motion.div className="mt-8 flex flex-col items-center" {...reveal(0.2)}>
              <p className="text-sm uppercase tracking-[0.16em] text-gray-300 dark:text-slate-300">Connect</p>
              <div className="mt-4 flex justify-center gap-4 sm:gap-6">
                <motion.a href="https://github.com/Elchoplays" target="_blank" rel="noopener noreferrer" className="grid h-12 w-12 place-items-center rounded-full border border-white/30 bg-white/10 text-white transition-colors duration-300 hover:bg-white/25 dark:border-white/20 dark:bg-white/8 dark:hover:bg-white/14" aria-label="GitHub Profile" whileHover={{ y: -3, scale: 1.06 }} whileTap={{ scale: 0.96 }}>
                ...
                <motion.a href="https://www.linkedin.com/in/eleanor-seaton/" target="_blank" rel="noopener noreferrer" className="grid h-12 w-12 place-items-center rounded-full border border-white/30 bg-white/10 text-white transition-colors duration-300 hover:bg-white/25 dark:border-white/20 dark:bg-white/8 dark:hover:bg-white/14" aria-label="LinkedIn Profile" whileHover={{ y: -3, scale: 1.06 }} whileTap={{ scale: 0.96 }}>
