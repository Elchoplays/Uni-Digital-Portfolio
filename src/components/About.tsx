      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-12 items-start md:items-stretch">
          ...
          <div className="md:col-span-3 flex">
            <motion.div className="flex h-full flex-1 flex-col bg-white/90 backdrop-blur rounded-2xl border border-white p-6 sm:p-8 shadow-lg" {...reveal(0.12)} whileHover={{ y: -4 }} transition={{ ...reveal(0.12).transition, y: { duration: 0.24 } }}>
          ...
          <div className="md:col-span-5 grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-12 items-stretch">
            <div className="md:col-span-2 flex flex-col gap-4">
              <motion.div className="text-left rounded-2xl border border-arup-red/20 bg-gradient-to-br from-white to-red-50/40 p-5 shadow-lg shadow-black/10 backdrop-blur" {...reveal(0.16)} whileHover={{ y: -4 }} transition={{ ...reveal(0.16).transition, y: { duration: 0.24 } }}>
              ...
              <motion.div className="rounded-2xl border border-white bg-white/90 backdrop-blur p-6 shadow-lg flex-1" {...reveal(0.2)} whileHover={{ y: -4 }} transition={{ ...reveal(0.2).transition, y: { duration: 0.24 } }}>
            ...
            <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-8 h-full items-stretch">
              <motion.div className="rounded-2xl border border-white bg-white/90 backdrop-blur p-6 shadow-lg h-full" {...reveal(0.24)} whileHover={{ y: -4 }} transition={{ ...reveal(0.24).transition, y: { duration: 0.24 } }}>
              ...
              <motion.div className="rounded-2xl border border-white bg-white/90 backdrop-blur p-6 shadow-lg h-full flex flex-col" {...reveal(0.3)} whileHover={{ y: -4 }} transition={{ ...reveal(0.3).transition, y: { duration: 0.24 } }}>
