  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        color: 'red',
        isDefault: true,
        description: "The Reservoir project gave me the opportunity to apply my Python skills in a real engineering context, moving from training exercises to practical problem-solving. My main task was to create a new Python script that automatically generated legend codes using data from the OpenGround database. \n\nThis project helped to build my confidence in coding, introduced me to more advanced techniques, and showed how AI tools like Copilot can support learning and development.",
        processDescription: "I started by reviewing the project requirements and exploring the OpenGround database to understand how the data was structured. I then planned the logic for a new legend code script. \n\nOne of the main challenges was that the script needed to read very long geology descriptions and match them to the most suitable legend codes, even though the descriptions were written in different ways. This was difficult because earlier versions of the script picked up the wrong geological features from other parts of the text. To resolve this, I created a priority system to help ensure the correct legend code was assigned. \n\nTo improve the script, I tested, rewrote, and refined the code. I also explored new Python libraries to make it cleaner and more efficient, and used Copilot to troubleshoot issues and learn different approaches. I added clear comments so that others can understand and reuse the code. \n\nThrough this process, I became more confident using Python in real engineering work. I also learned the importance of breaking problems down into simple steps and saw how AI tools can support learning. Overall, the project strengthened my coding, problem-solving, and teamwork skills, and prepared me to take on more complex technical challenges.",
